...
class ChannelTableSeeder extends Seeder
{
    public function run()
    {
        ...
        DB::table('channels')->insert([
                ...
                'name' => 'Default',
                'root_category_id' => 1,
                'home_page_content' => '<p>@include("shop::home.slider") @include("shop::home.featured-products") @include("shop::home.new-products")</p><div class="banner-container"><div class="left-banner"><img src="/themes/default/assets/images/a1.png" /></div><div class="right-banner"><img src="/themes/default/assets/images/a2.png" /> <img src="/themes/default/assets/images/a3.png" /></div></div>',
